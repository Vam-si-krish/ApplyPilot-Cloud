...
app.get('/version', (_req, res) => {
  ...
  const features = ['score-jobs-allow-rescore', 'score-company-parity', 'assess-jobs', 'llm', 'chatgpt-subscription', 'claude-user-login', 'chatgpt-user-login', 'tailor-queue', 'candidate-prompt-controls', 'custom-resume-sections'];
  let commit = 'unknown';
  try {
