...
> **Postscript:** this work was reverted the same night it deployed (half-deployed against an
> unmigrated DB — ADR 0070, DAY-12) and **re-landed on 2026-07-11** after the self-host cutover,
> migration-first (DAY-13). The paragraph above is the historical record of what was pending then.
